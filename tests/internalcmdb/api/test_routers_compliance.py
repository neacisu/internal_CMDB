...
def _mgr():
    ...
    mgr.get_ai_inventory.return_value = [
        {"system_name": "CMDB-Cognitive", "risk_level": "low", "purpose": "infra analysis",
         "data_types": ["metrics"], "model_ids": ["llama3"], "deployed_since": "2024-01-01",
         "owner_team": "platform", "human_oversight_level": "full", "last_audit": None}
    ]
    mgr.generate_compliance_report.return_value = "EU AI Act report"
    mgr.audit_data_lineage.return_value = {
        "entity_id": "host-001", "lineage_stages": [], "checked_at": "2024-01-01T00:00:00+00:00"
    }
    mgr.check_article_12.return_value = {
        "audit_trail": True, "audit_trail_detail": "Ledger",
        "decision_logging": True, "decision_logging_detail": "Logged",
        "model_versioning": True, "model_versioning_detail": "MLflow",
        "data_lineage": True, "data_lineage_detail": "Tracked",
        "hitl_feedback": True, "hitl_feedback_detail": "Active",
        "overall_compliant": True, "checked_at": "2024-01-01T00:00:00+00:00",
    }
    return mgr
...
def test_compliance_report():
    ...
    assert r.status_code == 200
    assert "report" in r.json() and "generated_at" in r.json()
