...
class TestRemediationEngine:
    ...
    @pytest.mark.asyncio
    async def test_rich_context_increases_confidence(self, engine: RemediationEngine) -> None:
    ...
    @pytest.mark.asyncio
    async def test_llm_latency_produces_restart_engine(self, engine: RemediationEngine) -> None:
        plan = await engine.propose(
            {
    ...
    @pytest.mark.asyncio
    async def test_unknown_type_falls_back_to_log(self, engine: RemediationEngine) -> None:
        plan = await engine.propose(
            {
