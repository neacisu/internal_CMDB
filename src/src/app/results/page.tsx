          ...
          {results.map((r) => {
            ...
            return (
              <TableRow key={String(r.alias)}>
                ...
                <TableCell className="text-xs max-w-35 truncate" style={{ color: "var(--tx3)" }}>{String(r.os ?? "—")}</TableCell>
          ...
          {results.map((r) => {
            ...
            return (
              <TableRow key={String(r.alias)}>
                ...
                <TableCell className="text-xs max-w-35 truncate" style={{ color: "var(--tx3)" }}>{String(d.os ?? "—")}</TableCell>
                <TableCell>
                  {d.docker_present
