...
export default function ObservabilityPanel() {
  ...
  const [editedForm, setEditedForm] = useState<ObservabilityConfig | null>(null);
  ...
  // No useEffect needed — eliminates the react-hooks/set-state-in-effect violation.
  const form = useMemo<ObservabilityConfig | null>(
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              onChange={e => setEditedForm(_f => ({ ...form, otlp_endpoint: e.target.value }))}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onValueChange={v => setEditedForm(_f => ({ ...form, otlp_protocol: v }))}
            >
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={e => setEditedForm(_f => ({ ...form, otlp_insecure: e.target.checked }))}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              onChange={e => setEditedForm(_f => ({ ...form, sample_rate: Number(e.target.value) }))}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onValueChange={v => setEditedForm(_f => ({ ...form, log_level: v }))}
            >
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={e => setEditedForm(_f => ({ ...form, debug_enabled: e.target.checked }))}
              className="h-4 w-4 rounded border-[oklch(0.24_0.012_255)] accent-(--ok) cursor-pointer"
            />
