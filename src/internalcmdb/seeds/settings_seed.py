...
_SETTINGS: list[tuple[str, str, object, str, str, bool, bool]] = [
    ...
    (
        ...
        "string",
        "Embedding model alias (LiteLLM → OpenRouter qwen/qwen3-embedding-8b)",
        False,
        False,
    ),
    (
        "llm.embed.api_format",
        "llm",
        "openai",
        "string",
    ...
    (
        "retention.high_freq_snapshots_days",
        "retention",
        3,
        "integer",
        "Days to retain high-frequency snapshots (heartbeat, container_resources) at full resolution",
        False,
        False,
    ),
    (
        "retention.vitals_downsample_days",
        "retention",
        3,
        "integer",
        "Days after which system_vitals are downsampled to one sample per agent per hour",
        False,
        False,
    ),
    (
        "collectors.heartbeat_snapshot_interval_seconds",
        "collectors",
        60,
        "integer",
        "Minimum seconds between stored heartbeat snapshots per agent (liveness updates on every ping regardless)",
        False,
        False,
    ),
    (
